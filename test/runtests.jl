...
@testset "UnnamedDimensionBasis tests" begin
    @test_throws ErrorException dim_basis(9.81u"m/s^2", 1u"mm", 1u"s")
    @test_throws ErrorException dim_basis(9.81u"m/s^2")

    basis = dim_basis(9.81u"m/s^2", 6371u"km", 1420788u"kg", 1u"mol/g")
...
@testset "NamedDimensionBasis tests" begin
    named_basis = dim_basis("a"=>1u"s", "b"=>2u"mm", "c"=>3u"bar")
    unnamed_basis = dim_basis(1u"s", 2u"mm", 3u"bar")
...
@testset "Change of basis tests" begin
    change_basis = dim_basis(1u"mA", 2u"mol", 3u"Pa*s", 4u"h", 5u"kg")
